module github.com/otto-de/otto-config/demo/go
...
require (
	...
	github.com/otto-de/otto-config/go v0.0.0-00010101000000-000000000000
)
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/appconfigdata v1.26.1 // indirect
...
replace github.com/otto-de/otto-config/go => ../../go
